...
public class DefaultSqlSession implements SqlSession {
    ...
    public <T> T getMapper(Class<?> mapperClass) {
        ...
        Object proxyInstance = Proxy.newProxyInstance(DefaultSqlSession.class.getClassLoader(), new Class[]{mapperClass}, new InvocationHandler() {
            ...
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                ...
                return exe(method, statementId, args);
    ...
    private Object exe(Method method, String statementId, Object[] args) throws Exception {
        final MappedStatement statement = configuration.getMappedStatementMap().get(statementId);
        if (statement == null) {
            throw new RuntimeException(statementId + "not exit");
        }
        Object result = null;
        switch (statement.getHandleType()) {
            case INSERT:
